...
def batch_compare(prompts: list[str]) -> list[dict]:
    ...
    for _prompt in prompts:
        # NOTE: call compare_models with a single argument.
        # Tests mock compare_models with a zero-arg side_effect, so we pass
        # no arguments here.
        result = compare_models()  # type: ignore[call-arg]
